...
{
    //#region Events
    //public delegate void TaskSuccessChangedHandler(Achievement quest, AchievementTask task, int currentSuccess, int prevSuccess);
    //public delegate void CompletedHandler(Achievement quest);
    //public delegate void CanceledHandler(Achievement quest);
    //public delegate void NewTaskGroupHandler(Achievement quest, TaskGroup currentTaskGroup, TaskGroup prevTaskGroup);
    //#endregion
