...
public class TaskDescriptor : MonoBehaviour
{
    ...
    public void UpdateText(AchievementTask task)
    {
    ...
    public void UpdateTextUsingStrikeThrough(AchievementTask task)
    {
    ...
    private string BuildText(AchievementTask task, string textColorCode, string successCountColorCode)
    {
